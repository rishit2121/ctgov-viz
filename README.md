...
Here is a shortened response for the drug-pair network example ([`examples/runs/04_network_drug_pairs`](examples/runs/)). The `// ...` comments mark where fields were cut; they are not part of the real JSON.
